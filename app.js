...
//mongoose.connect("mongodb://mongodb:27018/SocialDB");
mongoose.connect("mongodb://mongodb:27017/SocialDB", { useNewUrlParser: true, useUnifiedTopology: true });
...
app.use(session({
    ...
    cookie: { secure: false, maxAge: 3600000 }, // set maxAge to 1 hour
  }));
...
// Instead of an array, use the MongoDB Post model
app.post('/posts', authenticateJWT, async (req, res) => {
  ...
  // Modify other routes accordingly using the MongoDB models
